...
begin
  ...
  begin
    ...
    {reset line}
    if ( (KEY_LINE<>KEY_LINE_OLD) or (KEY_LINE_OLD='start') ) then begin
      ...
      {-----------------------------------------------------------------------------------------------}
      { ADD VALRES, ACOES E FINALIZA LINHA -----------------------------------------------------------}
      {-----------------------------------------------------------------------------------------------}
      If not (KEY_LINE_OLD='start') then begin
...
//    {-----------------------------------------------------------------------------------------------}
//    { ADD ACOES E FINALIZA LINHA -------------------------------------------------------------------}
//    {-----------------------------------------------------------------------------------------------}
//    if ( QT_COL = StrToInt(ttCols) ) then begin
//
//      {Add botao historico}
//      tabtd := tabtd + SLineBreak +
//      '       <td id="fitPad"> ' + SLineBreak +
