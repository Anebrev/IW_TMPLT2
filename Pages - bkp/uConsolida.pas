...
type
  ...
  private
    ...
    function getDataTableTH(): string;
    function getDataTableBody(): string;
...
procedure TIWFRM_Consolida.IWTemplateProcessorHTML1UnknownTag(
...
function TIWFRM_Consolida.getDataTableTH(): string;
var
  th1, th2: string;
begin
...
function TIWFRM_Consolida.getDataTableBody(): string;
begin
