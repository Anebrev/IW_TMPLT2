...
type
  TIWFRM_Consolida_tst = class(TIWBase)
...
var
  IWFRM_Consolida_tst: TIWFRM_Consolida_tst;
...
procedure TIWFRM_Consolida_tst.IWAppFormCreate(Sender: TObject);
begin
  inherited;
  //
...
function TIWFRM_Consolida_tst.getStepProgress(): string;
begin
...
procedure TIWFRM_Consolida_tst.IWTemplateProcessorHTML1UnknownTag(const AName: string; var VValue: string);
begin
  inherited;


  if AName = 'Step_ProgressBar' then   //{%Step_ProgressBar%}
    VValue := getStepProgress;
...
procedure TIWFRM_Consolida_tst.prc_Acao(EventParams: TStringList);
var
  filtro: string;
begin
  inherited;
...
function TIWFRM_Consolida_tst.getDataTableTH(th:string): string;
var
  th1, th2: string;
begin
...
function TIWFRM_Consolida_tst.getDataTableBody1(): string;
begin
...
function TIWFRM_Consolida_tst.getDataTableBody2(): string;
begin
...
function TIWFRM_Consolida_tst.getDataTableBody3(): string;
begin
...
function TIWFRM_Consolida_tst.getDataTable(filtro:string): string;
var
  html:string;
begin
...
function TIWFRM_Consolida_tst.getDataTableJSON(): string;
var
  html:string;
begin
