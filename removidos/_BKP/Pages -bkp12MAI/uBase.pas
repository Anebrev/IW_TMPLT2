...
begin
  ...
  try
    ...
    //Form Processa
    if Acao = IWFRM_Processa.PAGE_ID then begin
    ...
    //Form Consolida
    if Acao = IWFRM_Consolida.PAGE_ID then begin
    ...
    //Form Prévias
    if Acao = IWFRM_Previas.PAGE_ID then begin
    ...
    //Form Transmissão
    if Acao = IWFRM_Transmissao.PAGE_ID then begin
